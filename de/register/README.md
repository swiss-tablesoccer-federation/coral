🌐 **Sprache / Langue / Lingua:** **Deutsch** | [Français](../../fr/register/) | [Italiano](../../it/register/)
...
- [Coral Accounts](#coral-accounts)
- [Anmelden für Turniere](#anmelden-für-turniere)
- [Einem Club beitreten](#einem-club-beitreten)
- [Während eines Turniers](#während-eines-turniers)
- [Ein Turnier aufschalten](../tournaments/)
- [Häufig gestellte Fragen (FAQ)](#faq)
    * [\#1 Ich kann mich nicht für Competitions registrieren. Die einzelnen Disziplinen sind ausgegraut](#1-ich-kann-mich-nicht-für-competitions-registrieren-die-einzelnen-disziplinen-sind-ausgegraut)
    * [\#1.1 Ich kann bei der Registrierung meine/n Spielpartner/in nicht auswählen.](#11-ich-kann-bei-der-registrierung-meinen-spielpartnerin-nicht-auswählen)
    * [\#2 Coral zeigt nach dem Login auf dem PC nur eine weisse Oberfläche an](#2-coral-zeigt-nach-dem-login-auf-dem-pc-nur-eine-weisse-oberfläche-an)
    * [\#3.1 Wie kann ich Coral als Web-App installieren?](#31-wie-kann-ich-coral-als-web-app-installieren)
    * [\#3.2 Push-Benachrichtigungen funktionieren nicht auf meinem Handy](#32-push-benachrichtigungen-funktionieren-nicht-auf-meinem-handy)
    * [\#4 die Tabelle zeigt mir das Buchholz nicht an](#4-die-tabelle-zeigt-mir-das-buchholz-nicht-an)
    * [\#5 Ich habe mich angemeldet aber mein Status ist noch auf *pending*. Warum?](#5-ich-habe-mich-angemeldet-aber-mein-status-ist-noch-auf-pending-warum)
    * [\#6 Wie sind die Gebühren, welche mir angezeigt werden zu verstehen?](#6-wie-sind-die-gebühren-welche-mir-angezeigt-werden-zu-verstehen)
    * [\#7 Wo finde ich neu die Turnierausschreibung?](#7-wo-finde-ich-neu-die-turnierausschreibung)
    * [\#8 WLAN an Turniere](#8-wlan-an-turniere)
    * [\#9 Welche Lizenztypen gibt es in Coral und wie bilden sie sich auf die bekannten STF Strukturen ab?](#10-ich-erfülle-die-anforderungen-für-itsf-turniere-nicht)
    * [\#10 Ich erfülle die Anforderungen für ITSF-Turniere nicht](#10-ich-erfülle-die-anforderungen-für-itsf-turniere-nicht)
...
Um einem Club beitreten zu können kannst Du unter Deinem *Profile > Join Club* auswählen. Danach im Suchfeld nach Deinem Verein suchen, die passende Mitgliedschaft auswählen und erforderliche Informationen ausfüllen. Wähle die Mitgliedschaft gemäss [Lizenztypen ab 2026](../licenses/#lizenztypen-ab-2026).
...
Bitte folge zudem den Anweisungen zur Vorauszahlung gemäss der [Ausschreibung](#7-wo-finde-ich-neu-die-turnierausschreibung). Diese ist neu auch in Coral zu finden.
